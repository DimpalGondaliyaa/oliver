...
<div class="mainBox">
                    <a onclick="return confirm('Are You Sure to Back?')" href="<?php echo base_url(); ?>ProductDetails/destroyId" class="btn btn-back">Back to Home</a>
                    <p><b>NOTE : </b> If you Once Go Back, you will not be Able to Listen This Audio.</p>
        <div class="aBox">
              <div class="cont">
                <h3><?php // echo $a_data['product_name']; ?></h3>
              </div>
        <audio class="audio" controls="controls" controlsList="nodownload">
                <source type="audio/mpeg" src="<?php //echo base_url() ?>html/images/products/audios/<?php // echo $a_data['audio_file']; ?>">
        </audio>
    </div>
